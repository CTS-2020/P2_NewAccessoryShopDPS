<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrtRackmasterExp.aspx.cs" Inherits="PlcConvResult" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table class="table" width="100%" border="0">
                <tr>
                <td colspan="4">
                    <span class="titlemain"><asp:Label ID="lblTitleMain" runat="server" Text="Rack Master Result"></asp:Label></span>
                </td>
                </tr>
                <tr>
                <td colspan="4" class="titlesub">
                    <span class="titlesubfont"><asp:Label ID="lblTitleSub1" runat="server" Text="Rack Master Result"></asp:Label></span>
                </td>
                </tr>
                <tr>
