<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PhysicalAddMstReg.aspx.cs" Inherits="PhysicalAddMst" %>
            ...
            <table class="table" width="100%" border="0">
                ...
                <tr>
                    ...
                    <td class="tdtextbox" style="width: 40%; height: 30px">
                        <asp:TextBox ID="txtPhysicalAdd" runat="server" CssClass="TextboxStyle"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td colspan="4" class="alignRight">
                        <asp:Button ID="btnNewPhy" runat="server" CssClass="button" Text="Create" OnClick="btnNewPhy_Click" OnClientClick="Confirm('Confirm to save?')"/>
                ...
                <tr>
                    <td colspan="4">
                        ...
                        <asp:Label ID="lblTmpPhysicalAdd" runat="server" Visible="False"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td colspan="4">
                        <asp:GridView ID="gvPhysicalAddMst" runat="server" AutoGenerateColumns="false" AllowPaging="True" CssClass="DataTable" OnPageIndexChanging="gvPhysicalAddMst_PageIndexChanging" AllowSorting="True" EmptyDataText="No Data">
                            <Columns>
