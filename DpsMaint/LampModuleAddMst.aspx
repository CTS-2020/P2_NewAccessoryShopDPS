<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LampModuleAddMst.aspx.cs" Inherits="LampModuleAddMst" %>
        ...
        <div>
            <table class="table" width="100%" border="0">
                ...
                <td colspan="4" class="titlesub">
                    <span class="titlesubfont"><asp:Label ID="lblTitleSub1" runat="server" Text="Search Lamp Module Address Master List"></asp:Label></span>
                </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="4" class="alignRight">
                        <asp:Button ID="btnNewLmAdd" runat="server" CssClass="button" Text="New" OnClick="btnNewLmAdd_Click" />
                ...
                <tr>
                    <td colspan="4">
                        <asp:GridView ID="gvLampModuleAddMst" runat="server" AutoGenerateColumns="false" AllowPaging="True" CssClass="DataTable" OnRowDataBound="gvLampModuleAddMst_RowDataBound" OnRowCommand ="gvLampModuleAddMst_RowCommand" OnPageIndexChanging="gvLampModuleAddMst_PageIndexChanging" AllowSorting="True" EmptyDataText="No Data">
                            <Columns>
