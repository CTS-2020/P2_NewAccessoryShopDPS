...
namespace Itenso.Solutions.Community.Rtf2Html
{
	...
	public class RtfConverterDemo
	{
		...
		// ----------------------------------------------------------------------
        public static string ParserLogFileName { get; set; }

		// ----------------------------------------------------------------------
        public static string InterpreterLogFileName { get; set; }

		// ----------------------------------------------------------------------
        public static string ConvertRtf2Txt(string strRtf)
		{
			// parser
            IRtfGroup rtfStructure = ParseRtf(strRtf);
		...
		// ----------------------------------------------------------------------
		public static string ConvertRtf2Html( string strRtf )
		{
			// parser
            IRtfGroup rtfStructure = ParseRtf(strRtf);
			if ( rtfStructure == null )
		...
		// ----------------------------------------------------------------------
        private static IRtfGroup ParseRtf(string strRtf)
		{
            ...
            //{
                ...
                parser.Parse(new RtfSource(strRtf));
