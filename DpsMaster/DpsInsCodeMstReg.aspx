<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DpsInsCodeMstReg.aspx.cs" Inherits="DpsInsCodeMst" %>
        ...
        <div>
            <table class="table" width="100%" border="0">
                ...
                <td colspan="4" class="titlesub">
                    <span class="titlesubfont"><asp:Label ID="lblTitleSub1" runat="server" Text="Create/Update DPS Instruction Code Master"></asp:Label></span>
                </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="4" class="alignRight">
                        <asp:Button ID="btnNewInsCode" runat="server" CssClass="button" Text="Create" OnClick="btnNewInsCode_Click" OnClientClick="Confirm('Confirm to save?')"/>
                ...
                <tr>
                    <td colspan="4">
                        ...
                        <asp:Label ID="lblTmpInsCode" runat="server" Visible="False"></asp:Label>
                ...
                <tr>
                    <td colspan="4">
                        <asp:GridView ID="gvInsCodeMstList" runat="server" AutoGenerateColumns="false" AllowPaging="True" CssClass="DataTable" OnPageIndexChanging="gvInsCodeMstList_PageIndexChanging" AllowSorting="True" EmptyDataText="No Data">
                            <Columns>
