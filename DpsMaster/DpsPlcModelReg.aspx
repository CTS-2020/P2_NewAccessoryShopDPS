<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DpsPlcModelReg.aspx.cs" Inherits="DpsPlcMst" %>
        ...
        <div>
            <table class="table" width="100%" border="0">
                ...
                <td colspan="4" class="titlesub">
                    <span class="titlesubfont"><asp:Label ID="lblTitleSub1" runat="server" Text="Create/Update DPS GW Model List"></asp:Label></span>
                </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="4" class="alignRight">
                        <asp:Button ID="btnNewModel" runat="server" CssClass="button" Text="Create" OnClick="btnNewModel_Click" OnClientClick="Confirm('Confirm to save?')"/>
                ...
                <tr>
                    <td colspan="4">
                        ...
                        &nbsp;
                        <asp:Label ID="lblTmpModelNo" runat="server" Visible="False"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td colspan="4">
